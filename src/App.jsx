  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col">
      ...
      >
        ...
        <p className="text-sm text-gray-500 mt-0.5">Buellton, CA · PG&E with 3CE</p>
      ...
      >
        <RateDisplay planConfig={planConfig} />
        <Timeline planConfig={planConfig} />
        <Calculator planConfig={planConfig} />
        <ChargingTip planConfig={planConfig} />
      </main>
